...
simulation_name = "likelihood_eval_B_5000"
...
x_B = np.load("PAL_cineca/Data/Output/seq_optimization_B_05_3_trance.npy")
...
log_likelihood_B = np.zeros(n_reps)
for i in range(n_reps):
    
    log_likelihood_B[i] = optimization_func(x_B)
    
np.save("PAL_cineca/Data/Output/"+simulation_name+".npy", log_likelihood_B)
